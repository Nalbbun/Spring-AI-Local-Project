...
public class DebugRuntimeVllmConnectionService implements RuntimeVllmConnectionPort {
    ...
    public DebugRuntimeVllmConnectionService(
            ...
            @Value("${app.vllm.health-method:POST}") String defaultHealthCheckMethod,
        ...
        this.defaultHealthCheckMethod = normalizeMethod(defaultHealthCheckMethod, "POST");
    ...
    public void update(
            ...
            String requestedKeyProvider,
            String requestedHealthCheckPath,
            String requestedHealthCheckMethod,
            String requestedModelsPath,
            String requestedModelsMethod
    ) {
