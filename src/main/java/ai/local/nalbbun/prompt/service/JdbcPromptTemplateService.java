    ...
    public void initializeSchema() {
        try (Connection connection = dataSource.getConnection();
            ...
            statement.executeUpdate("""
                    ...
                    """);
            statement.executeUpdate("CREATE INDEX IF NOT EXISTS idx_prompt_template_page_scope ON prompt_template(page_scope, active)");
            statement.executeUpdate("CREATE INDEX IF NOT EXISTS idx_prompt_template_category ON prompt_template(category, active)");
        } catch (SQLException e) {
            throw new IllegalStateException("프롬프트 템플릿 스키마 초기화에 실패했습니다.", e);
        }
    }
