...
/**
 * Rag Source File Entry 타입이다.
 *
 * <p>기능 설명: 계층 간에 전달되는 도메인 데이터와 상태를 표현한다. 클래스 단위 책임이 명확하도록 관련 기능을 응집해 제공한다. 주요 속성 예시는 category, source, sourceKey, version, versionKey, fileId, fileName, originalFileName 이다.</p>
